...
namespace vtable_indexes
{
	...
	constexpr auto extraBonePro = 195;
	constexpr auto sceneEnd = 9;
	constexpr auto dopostscreeneffects = 44;
	constexpr auto viewmodelIndex = 35;
...
public:
	...
	static bool            __fastcall TempEntities_h(void* ECX, void* EDX, void* msg);
	static bool            __fastcall  PvsHandler(uintptr_t ecx, uintptr_t edi);
	...
	static float    __fastcall  ViewmodelNigga( );
	static void	    __fastcall	PostScreenEffects( void* thisptr, void* edx, CViewSetup* setup );

	static LRESULT  __stdcall   WndProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam );

	typedef bool(__thiscall *TempEntities_t)(void*, void*);
	TempEntities_t oTempEntities = nullptr;
...
private:
	...
	std::unique_ptr<VMTHook> pClientStateHook;
...
extern Hooks::TempEntities_t oTempEntities;
...
public:
	...
	HRESULT Unhook( const std::size_t index )
	{
		...
		//console::print_debug("unhooking 0x%.\n", this->pOriginalVMT[index]);
		return S_OK;
	};
...
public:
	...
	__forceinline T GetOldMethod( uint16_t index ) {
